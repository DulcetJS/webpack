...
try {
	var localWebpack = require.resolve(path.join(process.cwd(), "node_modules", "@dulcetjs/webpack", "bin", "webpack.js"));
	if(__filename !== localWebpack) {
		return require(localWebpack);
	}
} catch(e) {}
var yargs = require("yargs")
	.usage("@dulcetjs/webpack " + require("../package.json").version + "\n" +
